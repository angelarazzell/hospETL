--emergency visits and breach numbers for stacked bar chart
...
------------------------------------------------------------------------------------------------------
--quarterly elective activity for sparkline and growth bars 
create or replace view rep.vw_sparkline as
  ...
  group by hos.hospital_desc, booking_type
  order by hos.hospital_desc;
